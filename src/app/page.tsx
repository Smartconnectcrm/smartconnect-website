...
export default function HomePage() {
  return (
    <>
      {/* 3D Hero (client-only, no SSR issues) */}
      <HeroSlot />
      ...
      <div className="doc-prose">
        ...
        <div className="mt-10 card-soft p-5" style={{ background: "var(--card-soft)" }}>
          ...
          <p className="small-muted mt-2">
            Diese Website enthält keine Marketing-Behauptungen, keine erfundenen Kennzahlen,
            keine Zertifikats-Badges ohne Nachweis und keine Tracking-/Analytics-Tools ohne Einwilligung.
          </p>
        </div>
      </div>
    </>
